...
{   
    ...
    public static final BlockItem ITEM_PUMPKIN_PIE = new BlockItem(BLOCK_PUMPKIN_PIE, (new FabricItemSettings().maxCount(1).group(ItemGroup.FOOD)));
    public static final BlockItem ITEM_APPLE_PIE = new BlockItem(BLOCK_APPLE_PIE, (new FabricItemSettings().maxCount(1).group(ItemGroup.FOOD)));
    public static final BlockItem ITEM_SWEET_BERRY_PIE = new BlockItem(BLOCK_SWEET_BERRY_PIE, (new FabricItemSettings().maxCount(1).group(ItemGroup.FOOD)));
    public static final BlockItem ITEM_GLOW_BERRY_PIE = new BlockItem(BLOCK_GLOW_BERRY_PIE, (new FabricItemSettings().maxCount(1).group(ItemGroup.FOOD)));
